...
OS::~OS()
{
     ...
     * which resulted in root_dir having 1 child in ChildObjects pointing to
     * deleted memory. Also, as I observed, deleting a childObject from Parent dir
     * was not done in ~DirectoryObject constructorin. But this may work
     * automatical.
     */
}
...
int OS::start()
{
    ...
    std::vector<std::string> initMsgs{"Initiating OS...", "Initiating Filesystem...", "Initiating Shell...",
                                      "**Success**",      "Welcome to simulOS!",      "Entering the simulsh..."};
